...
# 乱数の範囲
$pGainminRandomValue = 0.0
$pGainmaxRandomValue = 100.0

$DGainminRandomValue = 0.0
$DGainmaxRandomValue = 10.0
...
for ($i = 1; $i -le $numberOfSimulations; $i++) {
    ...
    # 1. 乱数でパラメータを4つ生成
    $param1 = 0.0 + (Get-Random -Minimum $pGainminRandomValue -Maximum $pGainmaxRandomValue)
    $param2 = 0.0 + (Get-Random -Minimum $DGainminRandomValue -Maximum $DGainmaxRandomValue)
    $param3 = 0.0 + (Get-Random -Minimum $pGainminRandomValue -Maximum $pGainmaxRandomValue)
    $param4 = 0.0 + (Get-Random -Minimum $DGainminRandomValue -Maximum $DGainmaxRandomValue)
