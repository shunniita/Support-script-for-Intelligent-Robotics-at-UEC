...
# 乱数の範囲
$thrustminRandomValue = -1.0
$thrustmaxRandomValue = 1.0

$elevatorminRandomValue = -1.0
$elevatormaxRandomValue = 1.0
...
for ($i = 1; $i -le $numberOfSimulations; $i++) {
    ...
    # 1. 乱数でパラメータを10個生成
    $param01 = 0.0 + (Get-Random -Minimum $thrustminRandomValue  -Maximum $thrustmaxRandomValue)
    $param02 = 0.0 + (Get-Random -Minimum $thrustminRandomValue  -Maximum $thrustmaxRandomValue)
    $param03 = 0.0 + (Get-Random -Minimum $thrustminRandomValue  -Maximum $thrustmaxRandomValue)
    $param04 = 0.0 + (Get-Random -Minimum $thrustminRandomValue  -Maximum $thrustmaxRandomValue)
    $param05 = 0.0 + (Get-Random -Minimum $thrustminRandomValue  -Maximum $thrustmaxRandomValue)

    $param06 = 0.0 + (Get-Random -Minimum $elevatorminRandomValue -Maximum $elevatormaxRandomValue)
    $param07 = 0.0 + (Get-Random -Minimum $elevatorminRandomValue -Maximum $elevatormaxRandomValue)
    $param08 = 0.0 + (Get-Random -Minimum $elevatorminRandomValue -Maximum $elevatormaxRandomValue)
    $param09 = 0.0 + (Get-Random -Minimum $elevatorminRandomValue -Maximum $elevatormaxRandomValue)
    $param10 = 0.0 + (Get-Random -Minimum $elevatorminRandomValue -Maximum $elevatormaxRandomValue)
